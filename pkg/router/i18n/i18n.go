...
func GenerateI18nIdentifiers(templatePath string) []interfaces.InternationalizationIdentifier {
	var identifiers []interfaces.InternationalizationIdentifier
	...
	if len(nonEmptySegments) > 0 {
		...
		titleId := interfaces.InternationalizationIdentifier{
			Key:          titleKey,
		...
		descriptionId := interfaces.InternationalizationIdentifier{
			Key:          descriptionKey,
			Source:       "opinionated-schema",
			TemplatePath: templatePath,
		...
		if strings.Contains(templatePath, "create") || strings.Contains(templatePath, "new") {
			...
			buttonSubmitId := interfaces.InternationalizationIdentifier{
				Key:          buttonSubmitKey,
				Source:       "opinionated-schema",
				TemplatePath: templatePath,
				DefaultValue: "Submit",
			...
			buttonCancelId := interfaces.InternationalizationIdentifier{
				Key:          buttonCancelKey,
				Source:       "opinionated-schema",
				TemplatePath: templatePath,
				DefaultValue: "Cancel",
	...
	config, err := metadata.ParseYAMLMetadataForTemplate(templatePath)
...
func IntegrateWithCtxI18n(identifiers []interfaces.InternationalizationIdentifier) {
