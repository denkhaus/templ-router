...
func (m *mockRouterTemplateRegistry) GetTemplate(key string) (templ.Component, error) { return nil, nil }
func (m *mockRouterTemplateRegistry) GetTemplateFunction(key string) (func() interface{}, bool) { return nil, false }
...
func (m *mockRouterTemplateRegistry) GetTemplateByRoute(route string) (templ.Component, error) { return nil, nil }
...
func createRouterTestContainer() do.Injector {
	...
	do.Provide(injector, func(i do.Injector) (*pipeline.HandlerPipeline, error) {
		return pipeline.NewHandlerPipeline(nil, nil, nil, zap.NewNop()), nil
	})
