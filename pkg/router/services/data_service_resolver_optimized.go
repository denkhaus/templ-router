...
// OptimizedDataServiceResolver eliminates reflection through type-safe registration
type OptimizedDataServiceResolver struct {
	injector         do.Injector
	templateRegistry interfaces.TemplateRegistry
	serviceRegistry  map[string]interfaces.GenericDataService
}

// NewOptimizedDataServiceResolver creates a new reflection-free data service resolver
func NewOptimizedDataServiceResolver(i do.Injector) (interfaces.DataServiceResolver, error) {
	templateRegistry := do.MustInvoke[interfaces.TemplateRegistry](i)

	return &OptimizedDataServiceResolver{
		injector:         i,
...
func (r *OptimizedDataServiceResolver) RegisterDataService(interfaceType string, service interfaces.GenericDataService) {
	r.serviceRegistry[interfaceType] = service
}

// ResolveDataService resolves a data service by interface type without reflection
func (r *OptimizedDataServiceResolver) ResolveDataService(interfaceType string) (any, error) {
...
func (r *OptimizedDataServiceResolver) ResolveGenericDataService(interfaceType string) (interfaces.GenericDataService, error) {
	// First check the type-safe registry
	if service, exists := r.serviceRegistry[interfaceType]; exists {
		return service, nil
	}
...
func (r *OptimizedDataServiceResolver) findDataServiceInfo(interfaceType string) *interfaces.DataServiceInfo {
...
func (r *OptimizedDataServiceResolver) resolveNamedDataService(serviceName string) (any, error) {
...
func (r *OptimizedDataServiceResolver) HasDataService(interfaceType string) bool {
