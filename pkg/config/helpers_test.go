...
func TestGetDatabaseDSN(t *testing.T) {
	// Database configuration has been removed from the router core configuration.
	// This test is preserved for reference but skipped since database functionality
	// is no longer part of the core router package.
	t.Skip("Database configuration has been removed from router core")
}
