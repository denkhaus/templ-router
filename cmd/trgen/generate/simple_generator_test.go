	...
	templates := []types.TemplateInfo{
		{
			...
			TemplatePath: "templates/home.templ",
			PackageName:  "templates",
		...
		},
		{
			...
			TemplatePath: "templates/about.templ",
			PackageName:  "templates",
			PackageAlias: "templates",
			ImportPath:   "github.com/test/project/templates",
	...
	templates := []types.TemplateInfo{
		{
			...
			TemplatePath: "admin/users.templ",
			PackageName:  "admin",
			PackageAlias: "admin",
		...
		},
		{
			...
			TemplatePath: "public/home.templ",
			PackageName:  "public",
			PackageAlias: "public",
